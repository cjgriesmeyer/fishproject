...
/// @DnDVersion : 1
/// @DnDHash : 305A6471
/// @DnDArgument : "code" "if(distance_to_object(o_scrapTruck) < 350 && distance_to_object(o_scrapTruck) > 300){$(13_10)	$(13_10)	audio_sound_gain(anxietyCueSlow, .25, 250);$(13_10)	$(13_10)} else if(distance_to_object(o_scrapTruck) < 300){$(13_10)	$(13_10)	move_towards_point(o_scrapTruck.x, o_scrapTruck.y, 3);$(13_10)	$(13_10)	dir = point_direction(x, y, o_scrapTruck.x, o_scrapTruck.y);$(13_10)	image_angle += sin(degtorad(90 + dir - image_angle)) * rspeed;$(13_10)	$(13_10)	audio_sound_gain(anxietyCueSlow, .0, 1000);$(13_10)	audio_sound_gain(anxietyCueMedium, .5, 1000);$(13_10)	$(13_10)} else {$(13_10)	$(13_10)	move_towards_point(xstart, ystart, 2);$(13_10)	$(13_10)	dir = point_direction(x, y, xstart, ystart);$(13_10)	image_angle += sin(degtorad(270 + dir - image_angle)) * rspeed;$(13_10)$(13_10)	audio_sound_gain(anxietyCueSlow, 0, 1000);$(13_10)	audio_sound_gain(anxietyCueMedium, 0, 1000);$(13_10)	$(13_10)}"
if(distance_to_object(o_scrapTruck) < 350 && distance_to_object(o_scrapTruck) > 300){
	
	audio_sound_gain(anxietyCueSlow, .25, 250);
	
} else if(distance_to_object(o_scrapTruck) < 300){
	
	move_towards_point(o_scrapTruck.x, o_scrapTruck.y, 3);
	
	dir = point_direction(x, y, o_scrapTruck.x, o_scrapTruck.y);
